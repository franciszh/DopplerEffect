...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _velocityNumInput = __webpack_require__(160);

	var _velocityNumInput2 = _interopRequireDefault(_velocityNumInput);

	var _planet = __webpack_require__(161);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_planet2.default, { velocity: this.state.velocity }),
	                _react2.default.createElement(_velocityNumInput2.default, { velocity: this.state.velocity, onInputUpdate: function onInputUpdate(velocity) {
	                        return _this2.setState({ velocity: velocity });
	                    } })
	            );
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var VelocityNumInput = function VelocityNumInput(_ref) {
	    var velocity = _ref.velocity,
	        onInputUpdate = _ref.onInputUpdate;


	    var outputNewVelocity = function outputNewVelocity(velocity) {
	        if (velocity < 0) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            "div",
	            null,
	            _react2.default.createElement("input", { type: "number", value: velocity, onChange: function onChange(e) {
	        ...
	        _react2.default.createElement(
	            "div",
	            null,
	            _react2.default.createElement("input", { className: "input__range", type: "range", min: "-100", max: "100", onChange: function onChange(e) {
	                    return onInputUpdate(outputNewVelocity(e.target.value));
	                } })
	        )
	    );
	};

	exports.default = VelocityNumInput;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Planet = function Planet(_ref) {
	    ...
	    var planetColor = function planetColor(velocity) {
	        var saturate = ((Math.abs(velocity) / 100 + 0.2) * 4).toFixed(2);
	        return velocity == 0 || velocity > 100 || velocity < -100 ? {} : velocity > 0 ? { filter: "hue-rotate(335deg) saturate(" + saturate + ")" } : { filter: "hue-rotate(160deg) saturate(" + saturate + ")" };
	    };

	    return _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement("img", { style: planetColor(velocity), src: "./img/star-small.png" })
	    );
	};
